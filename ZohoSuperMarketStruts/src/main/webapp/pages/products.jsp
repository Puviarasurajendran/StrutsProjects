...
<body>
    ...
    <script>
        ...
        function addProduct() {
            ...
            const response = fetch('http://localhost:8080/ZohoSuperMarketStruts/demo/Zoho/v1/Products', {
                    method: 'POST',
                    headers: {
        ...
        function saveRow(row) {
            ...
            fetch('http://localhost:8080/ZohoSuperMarketStruts/demo/Zoho/v1/Products', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
